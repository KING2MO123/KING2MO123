...
📍 Québec, QC · 🎓 Étudiant en 2e année au **baccalauréat en informatique** à l'Université Laval

🔎 **À la recherche d'un stage en développement logiciel (été 2027)** — intérêt marqué pour l'IA.

Je conçois des applications modernes et robustes : logiciels desktop professionnels, applications full-stack et solutions d'IA locale, avec un souci constant de qualité (tests automatisés, architectures propres).

## 🛠️ Stack Technique
- **Langages** : C++, Python, JavaScript/TypeScript, SQL, HTML/CSS, Java
- **Frontend** : React, Next.js, Vite, Bootstrap, HTML/CSS/JS
- **Backend** : Node.js, Express, Python, FastAPI
- **Base de données** : SQLite, MongoDB, ChromaDB (vector database)
- **IA & Data** : LangGraph, Agentic RAG, Google Gemini, DeepSeek, Ollama, Web Scraping (Cheerio)
